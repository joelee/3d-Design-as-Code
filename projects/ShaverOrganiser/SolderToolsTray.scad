...
//  [Shape,   [    x,   y,  z], depth, width, width2, drain, extension_height ]
    ["cyl",   [   40,  30,  0],    6.6,     0,      0,  true,  3],  // Solder Bit 1
    ["cyl",   [   50,  30,  0],    6.6,     0,      0,  true,  3],  // Solder Bit 2
    ["cyl",   [   60,  30,  0],    6.6,     0,      0,  true,  3],  // Solder Bit 3
    ["cyl",   [   30,  30,  0],    6.6,     0,      0,  true,  3],  // Solder Bit 4
    ["cyl",   [   20,  30,  0],    6.6,     0,      0,  true,  3],  // Solder Bit 5
    ["cyl",   [   10,  30,  0],    6.6,     0,      0,  true,  3],  // Solder Bit 6
    
    ["rect",   [   00,  3,  0],    24,     28,      0,  true,  3],  // HeatGun Bit 1
    ["rect",   [   30,  3,  0],    24,     28,      0,  true,  3],  // HeatGun Bit 2
    ["rect",   [   60,  3,  0],    24,     28,      0,  true,  3],  // HeatGun Bit 3
    
    ["cyl",   [   10,  -26,  0],    23,     0,      0,  true, 30],  // Desolder sucker
...
//    ["cyl",   [  6, -15,  0],    38,     0,      0,  true,  30], // Cutlery 
    ...
    ["rect",  [  -45,  0,  0],    45,    66,      0,  true, 30]  // Misc Box
];
